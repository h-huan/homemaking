package com.hm.module.wms.controller.admin.order.shipment.vo.order;
...
import com.hm.module.wms.enums.DictTypeConstants;
...
public class WmsShipmentOrderRespVO {
    ...
    @Schema(description = "创建者名称", example = "HM")
    ...
    @Schema(description = "更新者名称", example = "HM")
