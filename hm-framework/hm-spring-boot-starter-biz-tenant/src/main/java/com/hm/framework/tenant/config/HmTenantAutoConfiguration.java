package com.hm.framework.tenant.config;

import com.hm.framework.common.biz.system.tenant.TenantCommonApi;
import com.hm.framework.common.enums.WebFilterOrderEnum;
import com.hm.framework.mybatis.core.util.MyBatisUtils;
import com.hm.framework.redis.config.HmCacheProperties;
import com.hm.framework.security.core.service.SecurityFrameworkService;
import com.hm.framework.tenant.core.aop.TenantIgnore;
import com.hm.framework.tenant.core.aop.TenantIgnoreAspect;
import com.hm.framework.tenant.core.db.TenantDatabaseInterceptor;
import com.hm.framework.tenant.core.job.TenantJobAspect;
import com.hm.framework.tenant.core.mq.rabbitmq.TenantRabbitMQInitializer;
import com.hm.framework.tenant.core.mq.redis.TenantRedisMessageInterceptor;
import com.hm.framework.tenant.core.mq.rocketmq.TenantRocketMQInitializer;
import com.hm.framework.tenant.core.redis.TenantRedisCacheManager;
import com.hm.framework.tenant.core.security.TenantSecurityWebFilter;
import com.hm.framework.tenant.core.service.TenantFrameworkService;
import com.hm.framework.tenant.core.service.TenantFrameworkServiceImpl;
import com.hm.framework.tenant.core.web.TenantContextWebFilter;
import com.hm.framework.tenant.core.web.TenantVisitContextInterceptor;
...
@AutoConfiguration
@ConditionalOnProperty(prefix = "hm.tenant", value = "enable", matchIfMissing = true) // 允许使用 hm.tenant.enable=false 禁用多租户
@EnableConfigurationProperties(TenantProperties.class)
public class HmTenantAutoConfiguration {
    ...
    @ConditionalOnClass(name = "com.hm.framework.mq.redis.core.interceptor.RedisMessageInterceptor")
    ...
    public RedisCacheManager tenantRedisCacheManager(RedisTemplate<String, Object> redisTemplate,
                                                     ...
                                                     HmCacheProperties hmCacheProperties,
                                                     TenantProperties tenantProperties) {
        // 创建 RedisCacheWriter 对象
        RedisConnectionFactory connectionFactory = Objects.requireNonNull(redisTemplate.getConnectionFactory());
        RedisCacheWriter cacheWriter = RedisCacheWriter.nonLockingRedisCacheWriter(connectionFactory,
                BatchStrategies.scan(hmCacheProperties.getRedisScanBatchSize()));
    ...
    @Configuration(proxyBeanMethods = false)
    @ConditionalOnClass(name = "com.hm.framework.quartz.core.handler.JobHandler")
