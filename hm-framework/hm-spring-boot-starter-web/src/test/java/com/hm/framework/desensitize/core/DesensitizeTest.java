package com.hm.framework.desensitize.core;

import com.hm.framework.common.util.json.JsonUtils;
import com.hm.framework.desensitize.core.annotation.Address;
import com.hm.framework.desensitize.core.regex.annotation.EmailDesensitize;
import com.hm.framework.desensitize.core.regex.annotation.RegexDesensitize;
import com.hm.framework.desensitize.core.slider.annotation.*;
import lombok.Data;
...
public class DesensitizeTest {
    ...
    public void test() {
        ...
        desensitizeDemo.setNickname("HM 家政");
        ...
        desensitizeDemo.setRegex("你好，我是HM 家政");
        desensitizeDemo.setAddress("北京市海淀区上地十街10号");
        desensitizeDemo.setOrigin("HM 家政");
        ...
        assertEquals("HM 家政", d.getOrigin());
    }
    ...
    public static class DesensitizeDemo {
        ...
        @RegexDesensitize(regex = "HM 家政", replacer = "*")
