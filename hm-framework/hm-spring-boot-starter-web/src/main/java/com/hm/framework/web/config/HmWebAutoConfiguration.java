package com.hm.framework.web.config;
...
import com.hm.framework.web.core.filter.CacheRequestBodyFilter;
import com.hm.framework.web.core.filter.DemoFilter;
import com.hm.framework.web.core.handler.GlobalExceptionHandler;
import com.hm.framework.web.core.handler.GlobalResponseBodyHandler;
...
public class HmWebAutoConfiguration {
     ...
     */
    @Bean
    @ConditionalOnProperty(value = "hm.demo", havingValue = "true")
