package com.hm.framework.jackson.config;

import com.hm.framework.common.util.json.JsonUtils;
import com.hm.framework.common.util.json.databind.NumberSerializer;
import com.hm.framework.common.util.json.databind.TimestampLocalDateTimeDeserializer;
import com.hm.framework.common.util.json.databind.TimestampLocalDateTimeSerializer;
...
@Slf4j
public class HmJacksonAutoConfiguration {
