...
public class HomemakingJobs {
    private final HmRepository repo;private final NotificationService notifications;private final PaymentService payments;
    public HomemakingJobs(HmRepository repo,NotificationService notifications,PaymentService payments){this.repo=repo;this.notifications=notifications;this.payments=payments;}
