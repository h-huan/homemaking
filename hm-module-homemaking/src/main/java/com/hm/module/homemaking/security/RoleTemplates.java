...
public final class RoleTemplates {
    ...
    public static final List<Template> ALL_TEMPLATES = List.of(
        ...
        new Template("MANAGER", "店长", "STORES", permissions("stores:read,write", "workers:read,write,bind", "services:read,write", "orders:read,dispatch,reschedule,cancel,fulfill,change,price", "customers:read", "aftersales:read,reject", "reviews:read,moderate", "schedule:read,write,review", "payment:read,receive")),
