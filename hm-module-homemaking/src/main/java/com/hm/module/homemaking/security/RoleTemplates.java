...
public final class RoleTemplates {
    ...
    public static final Set<String> ALL = permissions("stores:read,write", "workers:read,write,bind", "services:read,write",
            ...
            "reviews:read,moderate", "schedule:read,write,templates,review", "finance:read,statement,approve,payout,reconcile",
    ...
    public static final List<Template> ALL_TEMPLATES = List.of(
        ...
        new Template("MANAGER", "店长", "STORES", permissions("stores:read,write", "workers:read,write,bind", "services:read,write", "orders:read,dispatch,reschedule,cancel,fulfill,change,price", "customers:read", "aftersales:read,process,reject", "reviews:read,moderate", "schedule:read,write,review", "payment:read,receive")),
        ...
        new Template("SUPPORT", "客服", "STORES", permissions("stores:read", "workers:read", "services:read", "orders:read,reschedule,cancel,change", "customers:read", "aftersales:read,process,reject", "reviews:read,moderate", "schedule:read")),
