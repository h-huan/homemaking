...
public class OAuth2ClientController {
    ...
    @PreAuthorize("(@ss.hasPermission('system:oauth2-client:create')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('system:oauth2-client:update')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('system:oauth2-client:delete')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('system:oauth2-client:query')) and @ss.isPlatform()")
