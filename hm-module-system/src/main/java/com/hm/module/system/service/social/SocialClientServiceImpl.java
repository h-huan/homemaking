package com.hm.module.system.service.social;
...
import com.hm.framework.common.util.cache.CacheUtils;
import com.hm.framework.common.util.http.HttpUtils;
import com.hm.framework.common.util.object.BeanUtils;
import com.hm.module.system.api.social.dto.SocialWxQrcodeReqDTO;
import com.hm.module.system.api.social.dto.SocialWxaOrderNotifyConfirmReceiveReqDTO;
import com.hm.module.system.api.social.dto.SocialWxaOrderUploadShippingInfoReqDTO;
import com.hm.module.system.api.social.dto.SocialWxaSubscribeMessageSendReqDTO;
import com.hm.module.system.controller.admin.socail.vo.client.SocialClientPageReqVO;
import com.hm.module.system.controller.admin.socail.vo.client.SocialClientSaveReqVO;
import com.hm.module.system.dal.dataobject.social.SocialClientDO;
import com.hm.module.system.dal.mysql.social.SocialClientMapper;
import com.hm.module.system.dal.redis.RedisKeyConstants;
import com.hm.module.system.enums.social.SocialTypeEnum;
import com.hm.module.system.framework.justauth.core.AuthRequestFactory;
...
import static com.hm.framework.common.util.date.LocalDateTimeUtils.UTC_MS_WITH_XXX_OFFSET_FORMATTER;
import static com.hm.framework.common.util.date.LocalDateTimeUtils.toEpochSecond;
...
public class SocialClientServiceImpl implements SocialClientService {
     ...
     * 3. developer：开发版
     */
    @Value("${hm.wxa-code.env-version:release}")
     ...
     * 3. formal：正式版
     */
    @Value("${hm.wxa-subscribe-message.miniprogram-state:formal}")
