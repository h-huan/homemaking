...
public class TenantPackageController {
    ...
    @PreAuthorize("(@ss.hasPermission('system:tenant-package:create')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('system:tenant-package:update')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('system:tenant-package:delete')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('system:tenant-package:query')) and @ss.isPlatform()")
