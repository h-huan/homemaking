...
import com.hm.module.system.controller.admin.sms.vo.log.SmsLogRespVO;
import com.hm.module.system.dal.dataobject.sms.SmsLogDO;
import com.hm.module.system.service.sms.SmsLogService;
...
public class SmsLogController {
    ...
    @PreAuthorize("(@ss.hasPermission('system:sms-log:query')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('system:sms-log:export')) and @ss.isPlatform()")
