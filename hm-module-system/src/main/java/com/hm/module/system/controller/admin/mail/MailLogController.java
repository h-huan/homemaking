...
import com.hm.module.system.controller.admin.mail.vo.log.MailLogRespVO;
import com.hm.module.system.dal.dataobject.mail.MailLogDO;
import com.hm.module.system.service.mail.MailLogService;
...
public class MailLogController {
    ...
    @PreAuthorize("(@ss.hasPermission('system:mail-log:query')) and T(com.hm.framework.tenant.core.context.TenantContextHolder).getTenantId() == 1")
