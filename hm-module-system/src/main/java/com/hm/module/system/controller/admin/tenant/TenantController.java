...
public class TenantController {
    ...
    @PreAuthorize("(@ss.hasPermission('system:tenant:create')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('system:tenant:update')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('system:tenant:delete')) and @ss.isPlatform()")
    ...
    @Parameter(name = "id", description = "编号", required = true, example = "1024")
    @PreAuthorize("(@ss.hasPermission('system:tenant:query')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('system:tenant:export')) and @ss.isPlatform()")
