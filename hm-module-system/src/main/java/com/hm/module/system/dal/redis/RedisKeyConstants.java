package com.hm.module.system.dal.redis;
...
public interface RedisKeyConstants {
     ...
     */
    String DEPT_CHILDREN_ID_LIST = "hm:dept_children_ids";
     ...
     */
    String USER_ROLE_ID_LIST = "hm:user_role_ids";
     ...
     * VALUE 数据类型：String 角色编号集合
     */
    String MENU_ROLE_ID_LIST = "hm:menu_role_ids";
     ...
     */
    String PERMISSION_MENU_ID_LIST = "hm:permission_menu_ids";
     ...
     */
    String OAUTH_CLIENT = "hm:oauth_client";
     ...
     */
    String OAUTH2_ACCESS_TOKEN = "hm:oauth2_access_token:%s";
     ...
     */
    String NOTIFY_TEMPLATE = "hm:notify_template";
     ...
     */
    String MAIL_ACCOUNT = "hm:mail_account";
     ...
     * VALUE 数据格式：String 模版信息
     */
    String MAIL_TEMPLATE = "hm:mail_template";
     ...
     * VALUE 数据格式：String 模版信息
     */
    String SMS_TEMPLATE = "hm:sms_template";
     ...
     * VALUE 数据格式 String, 模版信息
     */
    String WXA_SUBSCRIBE_TEMPLATE = "hm:wxa_subscribe_template";
