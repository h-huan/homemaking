...
import com.hm.module.system.controller.admin.permission.vo.menu.MenuRespVO;
import com.hm.module.system.controller.admin.permission.vo.menu.MenuSaveVO;
import com.hm.module.system.controller.admin.permission.vo.menu.MenuSimpleRespVO;
...
public class MenuController {
    ...
    @PreAuthorize("(@ss.hasPermission('system:menu:create')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('system:menu:update')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('system:menu:delete')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('system:menu:query')) and @ss.isPlatform()")
