...
import com.hm.module.system.controller.admin.sms.vo.channel.SmsChannelRespVO;
import com.hm.module.system.controller.admin.sms.vo.channel.SmsChannelSaveReqVO;
import com.hm.module.system.controller.admin.sms.vo.channel.SmsChannelSimpleRespVO;
import com.hm.module.system.dal.dataobject.sms.SmsChannelDO;
import com.hm.module.system.service.sms.SmsChannelService;
...
public class SmsChannelController {
    ...
    @PreAuthorize("(@ss.hasPermission('system:sms-channel:create')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('system:sms-channel:update')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('system:sms-channel:delete')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('system:sms-channel:query')) and @ss.isPlatform()")
