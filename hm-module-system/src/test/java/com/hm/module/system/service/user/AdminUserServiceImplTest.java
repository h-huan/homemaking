package com.hm.module.system.service.user;
...
import com.hm.module.infra.api.config.ConfigApi;
import com.hm.module.infra.api.file.FileApi;
import com.hm.module.system.controller.admin.user.vo.profile.UserProfileUpdatePasswordReqVO;
import com.hm.module.system.controller.admin.user.vo.profile.UserProfileUpdateReqVO;
import com.hm.module.system.controller.admin.user.vo.user.UserImportExcelVO;
import com.hm.module.system.controller.admin.user.vo.user.UserImportRespVO;
import com.hm.module.system.controller.admin.user.vo.user.UserPageReqVO;
import com.hm.module.system.controller.admin.user.vo.user.UserSaveReqVO;
import com.hm.module.system.dal.dataobject.dept.DeptDO;
import com.hm.module.system.dal.dataobject.dept.PostDO;
import com.hm.module.system.dal.dataobject.dept.UserPostDO;
import com.hm.module.system.dal.dataobject.tenant.TenantDO;
import com.hm.module.system.dal.dataobject.user.AdminUserDO;
import com.hm.module.system.dal.mysql.dept.UserPostMapper;
import com.hm.module.system.dal.mysql.user.AdminUserMapper;
import com.hm.module.system.enums.common.SexEnum;
import com.hm.module.system.mq.producer.user.AdminUserProducer;
import com.hm.module.system.service.dept.DeptService;
import com.hm.module.system.service.dept.PostService;
...
import com.hm.module.system.service.tenant.TenantService;
...
import static com.hm.framework.common.util.collection.SetUtils.asSet;
import static com.hm.framework.common.util.date.LocalDateTimeUtils.buildBetweenTime;
import static com.hm.framework.common.util.date.LocalDateTimeUtils.buildTime;
...
import static com.hm.module.system.enums.ErrorCodeConstants.*;
import static com.hm.module.system.service.user.AdminUserServiceImpl.USER_INIT_PASSWORD_KEY;
...
public class AdminUserServiceImplTest extends BaseDbUnitTest {
    ...
    public void before() {
        // mock 初始化密码
        when(configApi.getConfigValueByKey(USER_INIT_PASSWORD_KEY)).thenReturn("hmyuanma");
    }
    ...
    public void testCreatUser_success() {
        ...
        when(passwordEncoder.encode(eq(reqVO.getPassword()))).thenReturn("hmyuanma");
        ...
        assertEquals("hmyuanma", user.getPassword());
    ...
    public void testImportUserList_02() {
        ...
        when(deptService.getDept(eq(dept.getId()))).thenReturn(dept);
        // mock passwordEncoder 的方法
        when(passwordEncoder.encode(eq("hmyuanma"))).thenReturn("java");
