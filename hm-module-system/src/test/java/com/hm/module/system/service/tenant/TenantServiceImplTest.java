package com.hm.module.system.service.tenant;

import com.hm.framework.common.enums.CommonStatusEnum;
import com.hm.framework.common.pojo.PageResult;
import com.hm.framework.tenant.config.TenantProperties;
import com.hm.framework.tenant.core.context.TenantContextHolder;
import com.hm.framework.test.core.ut.BaseDbUnitTest;
import com.hm.module.system.controller.admin.tenant.vo.tenant.TenantPageReqVO;
import com.hm.module.system.controller.admin.tenant.vo.tenant.TenantSaveReqVO;
import com.hm.module.system.dal.dataobject.permission.MenuDO;
import com.hm.module.system.dal.dataobject.permission.RoleDO;
import com.hm.module.system.dal.dataobject.tenant.TenantDO;
import com.hm.module.system.dal.dataobject.tenant.TenantPackageDO;
import com.hm.module.system.dal.mysql.tenant.TenantMapper;
import com.hm.module.system.enums.permission.RoleCodeEnum;
import com.hm.module.system.enums.permission.RoleTypeEnum;
import com.hm.module.system.service.permission.MenuService;
import com.hm.module.system.service.permission.PermissionService;
import com.hm.module.system.service.permission.RoleService;
import com.hm.module.system.service.tenant.handler.TenantInfoHandler;
import com.hm.module.system.service.tenant.handler.TenantMenuHandler;
import com.hm.module.system.service.user.AdminUserService;
...
import static com.hm.module.system.dal.dataobject.tenant.TenantDO.PACKAGE_ID_SYSTEM;
...
public class TenantServiceImplTest extends BaseDbUnitTest {
    ...
    public void testCreateTenant() {
        ...
        when(userService.createUser(argThat(user -> {
            ...
            assertEquals("HM", user.getNickname());
    ...
    public void testGetTenantByName() {
        // mock 数据
        TenantDO dbTenant = randomPojo(TenantDO.class, o -> o.setName("HM"));
        tenantMapper.insert(dbTenant);// @Sql: 先插入出一条存在的数据

        // 调用
        TenantDO result = tenantService.getTenantByName("HM");
        // 校验存在
        assertPojoEquals(result, dbTenant);
    }
