...
const getProject = async () => {
  const data = [
    ...
    {
      name: 'hm-ui-admin-vue3',
      icon: 'ep:element-plus',
      message: 'github.com/hmcode/hm-ui-admin-vue3',
      personal: 'Vue3 + element-plus 管理后台',
      time: new Date('2025-02-03'),
      color: '#409EFF'
    },
    {
      name: 'hm-ui-mall-uniapp',
      icon: 'icon-park-outline:mall-bag',
      message: 'github.com/hmcode/hm-ui-mall-uniapp',
    ...
    },
    {
      ...
      message: 'github.com/YunaiV/hm-cloud',
      personal: 'Spring Cloud 微服务架构',
      time: new Date('2025-04-05'),
      color: '#1890ff'
    },
    {
      name: 'hm-ui-admin-vben',
      icon: 'devicon:antdesign',
      message: 'github.com/hmcode/hm-ui-admin-vben',
      personal: 'Vue3 + vben5(antd) 管理后台',
      time: new Date('2025-05-06'),
      color: '#e18525'
    },
    {
      name: 'hm-ui-admin-uniapp',
      icon: 'ant-design:mobile',
      message: 'github.com/hmcode/hm-ui-admin-uniapp',
