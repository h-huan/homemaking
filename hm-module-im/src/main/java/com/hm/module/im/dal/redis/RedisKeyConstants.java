package com.hm.module.im.dal.redis;
...
public interface RedisKeyConstants {
     ...
     * VALUE 数据类型：{@link com.hm.module.im.enums.friend.ImFriendStateEnum}
     */
    String FRIEND_STATE = "hm:friend_state";
     ...
     */
    String GROUP_MEMBER_IDS = "hm:group_member_ids";
     ...
     */
    String IM_RTC_CALL_LOCK = "hm:im_rtc_call:%d:%s";
