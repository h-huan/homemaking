package com.hm.module.im.dal.dataobject.message.content;
 ...
 * 频道素材消息 payload
 * <p>
 * 对应 {@link com.hm.module.im.enums.ImContentTypeEnum#MATERIAL}（type=125）。
 * 客户端按本字段集渲染图文卡片；
...
public class MaterialMessage {
     ...
     * 素材内容类型
     * <p>
     * 枚举 {@link com.hm.module.im.enums.channel.ImChannelMaterialTypeEnum}
