package com.hm.module.mp.service.account;
...
import com.hm.module.mp.controller.admin.account.vo.MpAccountCreateReqVO;
import com.hm.module.mp.controller.admin.account.vo.MpAccountPageReqVO;
import com.hm.module.mp.controller.admin.account.vo.MpAccountUpdateReqVO;
import com.hm.module.mp.convert.account.MpAccountConvert;
import com.hm.module.mp.dal.dataobject.account.MpAccountDO;
import com.hm.module.mp.dal.mysql.account.MpAccountMapper;
import com.hm.module.mp.enums.ErrorCodeConstants;
...
import static com.hm.module.system.enums.ErrorCodeConstants.USER_USERNAME_EXISTS;
    ...
    public void initLocalCache() {
        ...
        TenantUtils.executeIgnore(() -> {
            ...
            try {
                ...
                log.error("[微信公众号 hm-module-mp - 表结构未导入][参考 https://doc.iocoder.cn/mp/build/ 开启]");
            }
