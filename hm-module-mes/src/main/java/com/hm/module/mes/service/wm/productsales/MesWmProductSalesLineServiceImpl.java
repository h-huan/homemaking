...
import com.hm.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLinePageReqVO;
import com.hm.module.mes.controller.admin.wm.productsales.vo.line.MesWmProductSalesLineSaveReqVO;
...
import com.hm.module.mes.dal.mysql.wm.productsales.MesWmProductSalesLineMapper;
import com.hm.module.mes.enums.qc.MesQcCheckResultEnum;
...
import com.hm.module.mes.dal.dataobject.wm.salesnotice.MesWmSalesNoticeLineDO;
import com.hm.module.mes.service.wm.salesnotice.MesWmSalesNoticeLineService;
...
public class MesWmProductSalesLineServiceImpl implements MesWmProductSalesLineService {
    ...
    @Override
    public com.hm.framework.common.pojo.PageResult<MesWmProductSalesLineDO> getProductSalesLinePage(
        ...
        if (pageReqVO.getSalesId() == null && pageReqVO.getClientId() != null) {
            ...
            if (CollUtil.isEmpty(salesList)) {
                return com.hm.framework.common.pojo.PageResult.empty();
            }
