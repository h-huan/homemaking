...
import com.hm.module.mes.controller.admin.pro.task.vo.MesProTaskIssuePageReqVO;
import com.hm.module.mes.controller.admin.pro.task.vo.MesProTaskIssueRespVO;
import com.hm.module.mes.controller.admin.pro.task.vo.MesProTaskIssueSaveReqVO;
...
import com.hm.module.mes.dal.dataobject.pro.task.MesProTaskIssueDO;
...
import com.hm.module.mes.service.pro.task.MesProTaskIssueService;
...
public class MesProTaskIssueController {
    ...
    private List<MesProTaskIssueRespVO> buildIssueRespVOList(List<MesProTaskIssueDO> list) {
        ...
        // 拼接 VO
        return com.hm.framework.common.util.collection.CollectionUtils.convertList(list, issue -> {
