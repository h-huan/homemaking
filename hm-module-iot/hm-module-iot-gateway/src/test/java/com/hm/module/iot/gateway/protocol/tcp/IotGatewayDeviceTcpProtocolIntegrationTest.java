package com.hm.module.iot.gateway.protocol.tcp;
...
import com.hm.module.iot.core.topic.topo.IotDeviceTopoGetReqDTO;
import com.hm.module.iot.core.util.IotDeviceAuthUtils;
import com.hm.module.iot.gateway.protocol.tcp.codec.IotTcpCodecTypeEnum;
import com.hm.module.iot.gateway.protocol.tcp.codec.IotTcpFrameCodec;
import com.hm.module.iot.gateway.protocol.tcp.codec.IotTcpFrameCodecFactory;
import com.hm.module.iot.gateway.serialize.IotMessageSerializer;
import com.hm.module.iot.gateway.serialize.json.IotJsonSerializer;
 ...
 * <p>使用步骤：
 * <ol>
 *     <li>启动 hm-module-iot-gateway 服务（TCP 端口 8091）</li>
 *     <li>运行以下测试方法：
 *         <ul>
...
//                    .setFixedLength(256)
    ...
    private static final String GATEWAY_PRODUCT_KEY = "CHANGE_ME";
    private static final String GATEWAY_DEVICE_NAME = "sub-ddd";
    private static final String GATEWAY_DEVICE_SECRET = "CHANGE_ME";

    // ===================== 子设备信息（根据实际情况修改，从 iot_device 表查询子设备） =====================

    private static final String SUB_DEVICE_PRODUCT_KEY = "CHANGE_ME";
    private static final String SUB_DEVICE_NAME = "chazuo-it";
    private static final String SUB_DEVICE_SECRET = "CHANGE_ME";
