package com.hm.module.iot.gateway.protocol.modbus.tcpserver.handler.upstream;
...
import com.hm.framework.common.exception.enums.GlobalErrorCodeConstants;
import com.hm.framework.common.pojo.CommonResult;
import com.hm.framework.common.util.json.JsonUtils;
import com.hm.module.iot.core.biz.IotDeviceCommonApi;
import com.hm.module.iot.core.biz.dto.IotDeviceAuthReqDTO;
import com.hm.module.iot.core.biz.dto.IotDeviceRespDTO;
import com.hm.module.iot.core.biz.dto.IotModbusDeviceConfigRespDTO;
import com.hm.module.iot.core.biz.dto.IotModbusPointRespDTO;
import com.hm.module.iot.core.enums.IotDeviceMessageMethodEnum;
import com.hm.module.iot.core.enums.modbus.IotModbusFrameFormatEnum;
import com.hm.module.iot.core.mq.message.IotDeviceMessage;
import com.hm.module.iot.core.topic.IotDeviceIdentity;
import com.hm.module.iot.core.util.IotDeviceAuthUtils;
import com.hm.module.iot.gateway.protocol.modbus.common.utils.IotModbusCommonUtils;
import com.hm.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrame;
import com.hm.module.iot.gateway.protocol.modbus.tcpserver.codec.IotModbusFrameEncoder;
import com.hm.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConfigCacheService;
import com.hm.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager;
import com.hm.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerConnectionManager.ConnectionInfo;
import com.hm.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager;
import com.hm.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPendingRequestManager.PendingRequest;
import com.hm.module.iot.gateway.protocol.modbus.tcpserver.manager.IotModbusTcpServerPollScheduler;
import com.hm.module.iot.gateway.service.device.IotDeviceService;
import com.hm.module.iot.gateway.service.device.message.IotDeviceMessageService;
import io.vertx.core.net.NetSocket;
import lombok.extern.slf4j.Slf4j;

import java.util.Map;

import static com.hm.framework.common.exception.enums.GlobalErrorCodeConstants.BAD_REQUEST;
import static com.hm.framework.common.exception.enums.GlobalErrorCodeConstants.INTERNAL_SERVER_ERROR;
import static com.hm.framework.common.exception.util.ServiceExceptionUtil.invalidParamException;
...
public class IotModbusTcpServerUpstreamHandler {
     ...
     * 处理自定义功能码帧
     * <p>
     * 异常分层翻译，参考 {@link com.hm.module.iot.gateway.protocol.http.handler.upstream.IotHttpAbstractHandler}
     */
