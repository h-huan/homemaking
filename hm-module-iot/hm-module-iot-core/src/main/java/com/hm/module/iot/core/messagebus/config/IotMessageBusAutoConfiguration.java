package com.hm.module.iot.core.messagebus.config;

import com.hm.framework.mq.redis.core.RedisMQTemplate;
import com.hm.framework.mq.redis.core.job.RedisPendingMessageResendJob;
import com.hm.framework.mq.redis.core.job.RedisStreamMessageCleanupJob;
import com.hm.framework.mq.redis.core.stream.AbstractRedisStreamMessage;
import com.hm.framework.mq.redis.core.stream.AbstractRedisStreamMessageListener;
import com.hm.module.iot.core.messagebus.core.IotMessageBus;
import com.hm.module.iot.core.messagebus.core.kafka.IotKafkaMessageBus;
import com.hm.module.iot.core.messagebus.core.local.IotLocalMessageBus;
import com.hm.module.iot.core.messagebus.core.rabbitmq.IotRabbitMQMessageBus;
import com.hm.module.iot.core.messagebus.core.redis.IotRedisMessageBus;
import com.hm.module.iot.core.messagebus.core.rocketmq.IotRocketMQMessageBus;
...
public class IotMessageBusAutoConfiguration {
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "hm.iot.message-bus", name = "type", havingValue = "local", matchIfMissing = true)
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "hm.iot.message-bus", name = "type", havingValue = "rocketmq")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "hm.iot.message-bus", name = "type", havingValue = "kafka")
    ...
    /**
     * 特殊：由于 HmRedisMQConsumerAutoConfiguration 关于 Redis stream 的消费是动态注册，所以这里只能拷贝相关的逻辑！！！
     *
     * @see com.hm.framework.mq.redis.config.HmRedisMQConsumerAutoConfiguration
     */
    @Configuration
    @ConditionalOnProperty(prefix = "hm.iot.message-bus", name = "type", havingValue = "redis")
    ...
    @Configuration
    @ConditionalOnProperty(prefix = "hm.iot.message-bus", name = "type", havingValue = "rabbitmq")
