...
import com.hm.module.infra.controller.admin.file.vo.file.FilePresignedUrlRespVO;
...
import com.hm.module.infra.framework.file.core.utils.FilePathUtils;
import com.hm.module.infra.framework.file.core.utils.FileTypeUtils;
...
public class FileServiceImpl implements FileService {
    ...
    String generateUploadPath(String name, String directory) {
        ...
        return "hm/" + TenantContextHolder.getRequiredTenantId() + "/" + UUID.randomUUID() + "/" + name;
    }
