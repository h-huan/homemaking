...
import com.hm.module.infra.controller.admin.file.vo.config.FileConfigRespVO;
...
import com.hm.module.infra.service.file.FileConfigService;
...
public class FileConfigController {
    ...
    @PreAuthorize("(@ss.hasPermission('infra:file-config:create')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('infra:file-config:update')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('infra:file-config:delete')) and @ss.isPlatform()")
    ...
    @PreAuthorize("(@ss.hasPermission('infra:file-config:query')) and @ss.isPlatform()")
