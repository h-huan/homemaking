package com.hm.module.infra.controller.admin.codegen;
...
import com.hm.module.infra.controller.admin.codegen.vo.CodegenDetailRespVO;
import com.hm.module.infra.controller.admin.codegen.vo.CodegenPreviewRespVO;
...
import com.hm.module.infra.controller.admin.codegen.vo.table.CodegenTableRespVO;
import com.hm.module.infra.controller.admin.codegen.vo.table.DatabaseTableRespVO;
import com.hm.module.infra.convert.codegen.CodegenConvert;
...
import com.hm.module.infra.service.codegen.CodegenService;
...
import static com.hm.framework.security.core.util.SecurityFrameworkUtils.getLoginUserNickname;
...
public class CodegenController {
    ...
    @Parameters({
            ...
            @Parameter(name = "name", description = "表名，模糊匹配", example = "hm"),
            @Parameter(name = "comment", description = "描述，模糊匹配", example = "HM")
    })
