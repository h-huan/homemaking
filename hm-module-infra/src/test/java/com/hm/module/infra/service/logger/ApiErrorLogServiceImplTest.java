package com.hm.module.infra.service.logger;
...
import com.hm.module.infra.controller.admin.logger.vo.apierrorlog.ApiErrorLogPageReqVO;
import com.hm.module.infra.dal.dataobject.logger.ApiErrorLogDO;
import com.hm.module.infra.dal.mysql.logger.ApiErrorLogMapper;
import com.hm.module.infra.enums.logger.ApiErrorLogProcessStatusEnum;
...
import static com.hm.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_NOT_FOUND;
import static com.hm.module.infra.enums.ErrorCodeConstants.API_ERROR_LOG_PROCESSED;
...
public class ApiErrorLogServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetApiErrorLogPage() {
        ...
        reqVO.setApplicationName("hm-test");
