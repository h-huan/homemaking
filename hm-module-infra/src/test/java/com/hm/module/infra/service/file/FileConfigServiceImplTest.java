package com.hm.module.infra.service.file;
...
import com.hm.module.infra.controller.admin.file.vo.config.FileConfigPageReqVO;
import com.hm.module.infra.controller.admin.file.vo.config.FileConfigSaveReqVO;
import com.hm.module.infra.dal.dataobject.file.FileConfigDO;
import com.hm.module.infra.dal.mysql.file.FileConfigMapper;
import com.hm.module.infra.framework.file.core.client.FileClient;
import com.hm.module.infra.framework.file.core.client.FileClientConfig;
import com.hm.module.infra.framework.file.core.client.FileClientFactory;
import com.hm.module.infra.framework.file.core.client.local.LocalFileClient;
import com.hm.module.infra.framework.file.core.client.local.LocalFileClientConfig;
import com.hm.module.infra.framework.file.core.enums.FileStorageEnum;
...
import static com.hm.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_DELETE_FAIL_MASTER;
import static com.hm.module.infra.enums.ErrorCodeConstants.FILE_CONFIG_NOT_EXISTS;
...
public class FileConfigServiceImplTest extends BaseDbUnitTest {
    ...
    public void testGetFileConfigPage() {
        // mock 数据
        FileConfigDO dbFileConfig = randomFileConfigDO().setName("HM 家政")
