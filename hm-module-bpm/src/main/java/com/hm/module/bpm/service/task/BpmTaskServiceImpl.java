...
import com.hm.module.bpm.controller.admin.task.vo.task.*;
import com.hm.module.bpm.convert.task.BpmTaskConvert;
import com.hm.module.bpm.dal.dataobject.definition.BpmFormDO;
import com.hm.module.bpm.dal.dataobject.definition.BpmProcessDefinitionInfoDO;
import com.hm.module.bpm.enums.definition.*;
import com.hm.module.bpm.enums.task.*;
...
import com.hm.module.bpm.service.comment.BpmCommentService;
import com.hm.module.bpm.service.definition.BpmFormService;
import com.hm.module.bpm.service.definition.BpmModelService;
...
import com.hm.module.bpm.service.message.dto.BpmMessageSendWhenTaskTimeoutReqDTO;
...
import static com.hm.module.bpm.framework.flowable.core.util.BpmnModelUtils.*;
...
//        }
    ...
    public void rejectTask(Long userId, @Valid BpmTaskRejectReqVO reqVO) {
        ...
        // 疑问：为什么要标记未通过呢？
        // 回答：例如说 A 任务被向前加签除 B 任务时，B 任务被审批不通过，此时 A 会被取消。而 hm-ui-admin-vue3 不展示“已取消”的任务，导致展示不出审批不通过的细节。
    ...
    public void returnTask(Long userId, BpmnModel bpmnModel, Task currentTask, FlowElement targetElement, BpmTaskReturnReqVO reqVO) {
        ...
        // ⑤ 使用 moveExecutionsToSingleActivityId 方法进行回退操作时，如果是多实例的用户任务【HM用户任务默认为多实例】，不会删除多实例任务的根数据 ACT_RU_EXECUTION
