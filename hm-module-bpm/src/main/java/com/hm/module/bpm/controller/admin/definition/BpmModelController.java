package com.hm.module.bpm.controller.admin.definition;
...
import com.hm.module.bpm.controller.admin.definition.vo.model.*;
...
import com.hm.module.bpm.service.definition.BpmCategoryService;
...
import static com.hm.module.bpm.enums.ErrorCodeConstants.MODEL_IMPORT_FAIL_INVALID;
...
public class BpmModelController {
    ...
    @Parameters({
            ...
            @Parameter(name = "key", description = "流程标识，替换导入文件中的标识", example = "process_hm"),
            @Parameter(name = "name", description = "流程名称，替换导入文件中的名称", example = "HM")
    })
