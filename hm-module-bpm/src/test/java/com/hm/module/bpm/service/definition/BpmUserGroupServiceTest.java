...
import com.hm.module.bpm.controller.admin.definition.vo.group.BpmUserGroupSaveReqVO;
import com.hm.module.bpm.controller.admin.definition.vo.group.BpmUserGroupPageReqVO;
import com.hm.module.bpm.dal.dataobject.definition.BpmUserGroupDO;
import com.hm.module.bpm.dal.mysql.definition.BpmUserGroupMapper;
...
import static com.hm.module.bpm.enums.ErrorCodeConstants.USER_GROUP_NOT_EXISTS;
...
public class BpmUserGroupServiceTest extends BaseDbUnitTest {
    ...
    public void testGetUserGroupPage() {
       ...
       // 测试 name 不匹配
       userGroupMapper.insert(cloneIgnoreId(dbUserGroup, o -> o.setName("HM")));
       // 测试 status 不匹配
