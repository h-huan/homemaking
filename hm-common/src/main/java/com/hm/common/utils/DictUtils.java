...
public class DictUtils
{
    ...
    public static List<SysDictData> getDictCache(String key)
    {
        ...
        if (cacheObject instanceof JSONArray arrayCache)
        {
            return arrayCache.toList(SysDictData.class);
        }
        if (cacheObject instanceof List<?> list)
        {
            return list.stream().filter(SysDictData.class::isInstance).map(SysDictData.class::cast).toList();
        }
        return null;
    }
