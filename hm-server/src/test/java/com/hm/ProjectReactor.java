...
public class ProjectReactor {
    ...
    private static final String GROUP_ID = "com.hm";
    private static final String ARTIFACT_ID = "hm";
    private static final String PACKAGE_NAME = "com.hm";
    private static final String TITLE = "HM 家政管理平台";
