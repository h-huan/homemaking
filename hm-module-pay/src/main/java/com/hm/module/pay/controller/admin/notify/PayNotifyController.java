package com.hm.module.pay.controller.admin.notify;
...
import com.hm.module.pay.controller.admin.notify.vo.PayNotifyTaskDetailRespVO;
import com.hm.module.pay.controller.admin.notify.vo.PayNotifyTaskPageReqVO;
import com.hm.module.pay.controller.admin.notify.vo.PayNotifyTaskRespVO;
import com.hm.module.pay.dal.dataobject.app.PayAppDO;
import com.hm.module.pay.dal.dataobject.notify.PayNotifyLogDO;
import com.hm.module.pay.dal.dataobject.notify.PayNotifyTaskDO;
...
import static com.hm.module.pay.enums.ErrorCodeConstants.CHANNEL_NOT_FOUND;
...
public class PayNotifyController {
    ...
    public String notifyOrder(@PathVariable("channelId") Long channelId,
        ...
        log.info("[notifyOrder][channelId({}) callback received]", channelId);
        // 1. 校验支付渠道是否存在
    ...
    public String notifyRefund(@PathVariable("channelId") Long channelId,
                               ...
                               @RequestBody(required = false) String body,
                               @RequestHeader Map<String, String> headers) {
        log.info("[notifyRefund][channelId({}) callback received]", channelId);
        // 1. 校验支付渠道是否存在
        PayClient payClient = channelService.getPayClient(channelId);
        if (payClient == null) {
    ...
    public String notifyTransfer(@PathVariable("channelId") Long channelId,
                                 ...
                                 @RequestBody(required = false) String body,
                                 @RequestHeader Map<String, String> headers) {
        log.info("[notifyTransfer][channelId({}) callback received]", channelId);
        // 1. 校验支付渠道是否存在
        PayClient payClient = channelService.getPayClient(channelId);
        if (payClient == null) {
