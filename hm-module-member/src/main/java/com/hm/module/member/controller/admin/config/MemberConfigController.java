package com.hm.module.member.controller.admin.config;

import com.hm.framework.common.pojo.CommonResult;
import com.hm.module.member.controller.admin.config.vo.MemberConfigRespVO;
import com.hm.module.member.controller.admin.config.vo.MemberConfigSaveReqVO;
import com.hm.module.member.convert.config.MemberConfigConvert;
import com.hm.module.member.dal.dataobject.config.MemberConfigDO;
import com.hm.module.member.service.config.MemberConfigService;
