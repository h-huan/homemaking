package com.hm.module.erp.controller.admin.stock.vo.in;
...
import static com.hm.module.erp.enums.DictTypeConstants.AUDIT_STATUS;
...
public class ErpStockInRespVO {
    ...
    @Schema(description = "供应商名称", example = "HM")
    @ExcelProperty("供应商名称")
    ...
    @Schema(description = "创建人", example = "HM")
    private String creator;
    @Schema(description = "创建人名称", example = "HM")
