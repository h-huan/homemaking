package com.hm.module.ai.framework.ai.core.model;
...
import com.hm.framework.common.util.spring.SpringUtils;
import com.hm.module.ai.enums.model.AiPlatformEnum;
import com.hm.module.ai.framework.ai.config.AiAutoConfiguration;
import com.hm.module.ai.framework.ai.config.HmAiProperties;
...
import com.hm.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageApi;
import com.hm.module.ai.framework.ai.core.model.siliconflow.SiliconFlowImageModel;
...
public class AiModelFactoryImpl implements AiModelFactory {
    ...
    public MidjourneyApi getOrCreateMidjourneyApi(String rawApiKey, String rawUrl) {
        ...
        return Singleton.get(cacheKey, (Func0<MidjourneyApi>) () -> {
            HmAiProperties.Midjourney properties = SpringUtil.getBean(HmAiProperties.class)
                    .getMidjourney();
    ...
    private ChatModel buildYiYanChatModel(String apiKey) {
        HmAiProperties.YiYan properties = new HmAiProperties.YiYan()
                .setApiKey(apiKey);
    ...
    /**
     * 可参考 {@link AiAutoConfiguration#buildGeminiChatClient(HmAiProperties.Gemini)}
     */
    private static GeminiChatModel buildGeminiChatModel(String apiKey) {
        HmAiProperties.Gemini properties = SpringUtil.getBean(HmAiProperties.class)
    ...
    private GrokChatModel buildGrokChatModel(String apiKey, String url) {
        HmAiProperties.Grok properties = new HmAiProperties.Grok()
                .setBaseUrl(url)
                .setApiKey(apiKey);
