package com.hm.module.ai.service.chat;
...
import com.hm.module.ai.controller.admin.chat.vo.message.AiChatMessagePageReqVO;
import com.hm.module.ai.controller.admin.chat.vo.message.AiChatMessageRespVO;
import com.hm.module.ai.controller.admin.chat.vo.message.AiChatMessageSendReqVO;
import com.hm.module.ai.controller.admin.chat.vo.message.AiChatMessageSendRespVO;
import com.hm.module.ai.dal.dataobject.chat.AiChatConversationDO;
import com.hm.module.ai.dal.dataobject.chat.AiChatMessageDO;
import com.hm.module.ai.dal.dataobject.knowledge.AiKnowledgeDocumentDO;
import com.hm.module.ai.dal.dataobject.model.AiChatRoleDO;
import com.hm.module.ai.dal.dataobject.model.AiModelDO;
import com.hm.module.ai.dal.dataobject.model.AiToolDO;
import com.hm.module.ai.dal.mysql.chat.AiChatMessageMapper;
import com.hm.module.ai.enums.ErrorCodeConstants;
import com.hm.module.ai.enums.model.AiPlatformEnum;
import com.hm.module.ai.framework.ai.core.webserch.AiWebSearchClient;
import com.hm.module.ai.framework.ai.core.webserch.AiWebSearchRequest;
import com.hm.module.ai.framework.ai.core.webserch.AiWebSearchResponse;
import com.hm.module.ai.service.knowledge.AiKnowledgeDocumentService;
import com.hm.module.ai.service.knowledge.AiKnowledgeSegmentService;
import com.hm.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchReqBO;
import com.hm.module.ai.service.knowledge.bo.AiKnowledgeSegmentSearchRespBO;
import com.hm.module.ai.service.model.AiChatRoleService;
import com.hm.module.ai.service.model.AiModelService;
import com.hm.module.ai.service.model.AiToolService;
import com.hm.module.ai.util.AiUtils;
import com.hm.module.ai.util.FileTypeUtils;
...
import static com.hm.framework.common.pojo.CommonResult.error;
...
import static com.hm.module.ai.enums.ErrorCodeConstants.CHAT_CONVERSATION_NOT_EXISTS;
import static com.hm.module.ai.enums.ErrorCodeConstants.CHAT_MESSAGE_NOT_EXIST;
...
public class AiChatMessageServiceImpl implements AiChatMessageService {
    ...
    @Autowired(required = false) // 由于 hm.ai.web-search.enable 配置项，可以关闭 AiWebSearchClient 的功能，所以这里只能不强制注入
    private AiWebSearchClient webSearchClient;

    @SuppressWarnings("SpringJavaAutowiredFieldsWarningInspection")
    @Autowired(required = false) // 由于 hm.ai.mcp.client.enable 配置项，可以关闭 McpSyncClient 的功能，所以这里只能不强制注入
